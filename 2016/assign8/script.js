...
myApp.controller("general", ['$scope', '$http', '$localStorage', function ($scope, $http, $localStorage) {
    $http.get('index.php?st=state').then(function (response) {
        $scope.item = [];
    ...
    $http.get('index.php?st=house').then(function (response) {

        $scope.hos = response.data.results;
    });
    $http.get('index.php?st=senate').then(function (response) {

        $scope.sen = response.data.results;
    });

    /*Bills*/
    $http.get('index.php?st=active').then(function (response) {
        $scope.ac = response.data.results;
    });
    $http.get('index.php?st=new').then(function (response) {
    ...
    /*Committies*/
    $http.get('index.php?st=hs').then(function (response) {
        $scope.hs = response.data.results;
    });
    $http.get('index.php?st=sen').then(function (response) {
        $scope.sen1 = response.data.results;
    });
    $http.get('index.php?st=joint').then(function (response) {
    ...
    $scope.myFunction = function (idno) {
        ...
        $http.get('index.php?st=bill&id=' + $scope.id).then(function (response) {
            $scope.bill = response.data.results;
        });
        $http.get('index.php?st=comit1&chamber='+$scope.ch+'&member_ids='+ $scope.id).then(function (response) {
    ...
    $scope.myFunction1 = function (idno) {
        ...
        $http.get('index.php?st=bill&id=' + $scope.id1).then(function (response) {
            $scope.bill2 = response.data.results;
        });
        $http.get('index.php?st=comit1&chamber='+$scope.ch1+'&member_ids='+ $scope.id1).then(function (response) {
